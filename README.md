...
| --- | --- |
| `resume-writing` | Bullet composition, word choice, keyword placement, tailoring, gendered language bias |
| `resumx` | Resumx Markdown-to-PDF renderer syntax, CLI, tags, views, page fitting, multi-language |
